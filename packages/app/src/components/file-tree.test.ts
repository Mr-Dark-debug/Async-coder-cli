...
beforeAll(async () => {
  ...
  mock.module("@async-coder/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@async-coder/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@async-coder/ui/icon", () => ({ Icon: () => null }))
  mock.module("@async-coder/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
