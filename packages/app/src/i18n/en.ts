export const dict = {
  ...
  "dialog.advisor.variant.title": "Select Sage reasoning · {{model}}",
  "dialog.advisor.variant.default": "Default",
  "dialog.advisor.variant.unsupported": "This model does not advertise configurable reasoning levels",
  "dialog.advisor.error.title": "Could not configure Sage",
  ...
  "dialog.provider.kilo.note": "Gateway access to coding-focused frontier models",
