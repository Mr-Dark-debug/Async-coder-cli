import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@async-coder/sdk/v2"
import { SessionTurn } from "@async-coder/ui/session-turn"
import { SessionReview } from "@async-coder/ui/session-review"
import { DataProvider } from "@async-coder/ui/context"
import { FileComponentProvider } from "@async-coder/ui/context/file"
import { WorkerPoolProvider } from "@async-coder/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@async-coder/ui/logo"
import { IconButton } from "@async-coder/ui/icon-button"
import { ProviderIcon } from "@async-coder/ui/provider-icon"
import { iife } from "@async-coder/shared/util/iife"
import { Binary } from "@async-coder/shared/util/binary"
...
import { MessageNav } from "@async-coder/ui/message-nav"
import { FileSSR } from "@async-coder/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@async-coder/ui/pierre/worker").then((m) => ({
