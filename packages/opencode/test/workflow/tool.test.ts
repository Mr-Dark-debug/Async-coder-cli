...
describe("WorkflowTool run", () => {
  ...
  const originalFlag = Flag.ASYNC_CODER_EXPERIMENTAL_WORKFLOW_TOOL
  beforeAll(() => {
    Flag.ASYNC_CODER_EXPERIMENTAL_WORKFLOW_TOOL = true
  })
  afterAll(() => {
    Flag.ASYNC_CODER_EXPERIMENTAL_WORKFLOW_TOOL = originalFlag
  })
