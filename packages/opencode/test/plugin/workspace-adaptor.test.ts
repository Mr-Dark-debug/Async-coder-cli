...
const experimental = Flag.ASYNC_CODER_EXPERIMENTAL_WORKSPACES

Flag.ASYNC_CODER_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.ASYNC_CODER_EXPERIMENTAL_WORKSPACES = experimental
})
