...
const dir = path.join(os.tmpdir(), "async-coder-test-data-" + process.pid)
...
process.env["ASYNC_CODER_TEST_TMPDIR_ROOT"] = fixtureRoot
afterAll(async () => {
...
process.env["ASYNC_CODER_MODELS_PATH"] = path.join(import.meta.dir, "tool", "fixtures", "models-api.json")
...
process.env["ASYNC_CODER_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir
process.env["ASYNC_CODER_DISABLE_DEFAULT_PLUGINS"] = "true"

// Write the cache version file to prevent global/index.ts from clearing the cache
const cacheDir = path.join(dir, "cache", "async-coder")
...
delete process.env["ASYNC_CODER_SERVER_PASSWORD"]
delete process.env["ASYNC_CODER_SERVER_USERNAME"]
delete process.env["ASYNC_CODER_HOME"]

// Use in-memory sqlite
process.env["ASYNC_CODER_DB"] = ":memory:"
