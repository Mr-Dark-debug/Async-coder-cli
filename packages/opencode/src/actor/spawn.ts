 ...
 * TODO: lift to async-coder.json config (e.g. actor.maxPreReact) and add per-hook
  ...
  Effect.gen(function* () {
    ...
    const forkWork = (input: {
      ...
      Effect.gen(function* () {
        ...
        // ignored: not reachable in normal usage (async-coder run sets no such rule, spawn doesn't
