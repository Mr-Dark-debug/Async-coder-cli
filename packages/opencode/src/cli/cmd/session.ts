...
function pagerCmd(): string[] {
  ...
  if (Flag.ASYNC_CODER_GIT_BASH_PATH) {
    const less = path.join(Flag.ASYNC_CODER_GIT_BASH_PATH, "..", "..", "usr", "bin", "less.exe")
...
export const SessionImportClaudeCommand = cmd({
  ...
  describe: "import Claude Code sessions (~/.claude/projects) into async-coder",
  builder: (yargs: Argv) =>
    yargs.option("force", {
