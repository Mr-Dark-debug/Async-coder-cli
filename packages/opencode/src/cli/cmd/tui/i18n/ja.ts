...
export const dict = {
  ...
  "tui.home.agreement.prefix": "async-coder をご利用いただくことで、",
  ...
  "tui.tips.config_files":
    "サーバ設定は {highlight}async-coder.json{/highlight}、TUI 設定は {highlight}tui.json{/highlight} を作成します",
  "tui.tips.global_config":
    "TUI 設定をグローバルに置くなら {highlight}~/.config/async-coder/tui.json{/highlight} を使います",
  ...
  "tui.tips.mcp_oauth": "async-coder は認証が必要なリモート MCP サーバの OAuth を自動処理します",
  "tui.tips.custom_command":
    "{highlight}.async-coder/command/{/highlight} に {highlight}.md{/highlight} ファイルを追加すると再利用可能なカスタムプロンプトを定義できます",
  ...
  "tui.tips.custom_agent":
    "{highlight}.async-coder/agent/{/highlight} に {highlight}.md{/highlight} ファイルを追加して専用 AI ペルソナを作れます",
  ...
  "tui.tips.formatter": "async-coder は prettier、gofmt、ruff などでファイルを自動整形します",
  ...
  "tui.tips.lsp": "async-coder はインテリジェントなコード解析に LSP サーバを使います",
  "tui.tips.custom_tool":
    "{highlight}.async-coder/tools/{/highlight} に {highlight}.ts{/highlight} ファイルを作って新しい LLM ツールを定義します",
  "tui.tips.tool_scripts": "ツール定義から Python、Go などのスクリプトを呼び出せます",
  "tui.tips.plugins":
    "{highlight}.async-coder/plugin/{/highlight} に {highlight}.ts{/highlight} ファイルを追加してイベントフックを実装できます",
  "tui.tips.plugin_notify": "プラグインでセッション完了時に OS 通知を送れます",
  "tui.tips.plugin_protect": "プラグインを書いて async-coder が機密ファイルを読まないようにできます",
  "tui.tips.run": "{highlight}async-coder run{/highlight} で非対話的なスクリプト実行ができます",
  "tui.tips.continue": "{highlight}async-coder --continue{/highlight} で前回のセッションを再開します",
  "tui.tips.attach_cli": "{highlight}async-coder run -f file.ts{/highlight} で CLI からファイルを添付できます",
  "tui.tips.format_json": "{highlight}--format json{/highlight} を使うとスクリプトで機械可読な出力を得られます",
  "tui.tips.serve": "{highlight}async-coder serve{/highlight} を実行するとヘッドレスで async-coder API にアクセスできます",
  "tui.tips.attach_server": "{highlight}async-coder run --attach{/highlight} で起動中のサーバに接続します",
  "tui.tips.upgrade": "{highlight}async-coder upgrade{/highlight} で最新バージョンに更新します",
  "tui.tips.auth_list": "{highlight}async-coder auth list{/highlight} で設定済みプロバイダを確認します",
  "tui.tips.agent_create": "{highlight}async-coder agent create{/highlight} でガイド付きエージェント作成を行います",
  "tui.tips.github_trigger": "GitHub の issue/PR で {highlight}/opencode{/highlight} を入力すると AI を起動します",
  "tui.tips.github_install": "{highlight}async-coder github install{/highlight} で GitHub workflow を設定します",
  ...
  "tui.tips.theme_files": "{highlight}.async-coder/themes/{/highlight} ディレクトリに JSON テーマファイルを作成します",
  ...
  "tui.tips.debug_config": "{highlight}async-coder debug config{/highlight} で設定の問題を調査します",
  ...
  "tui.tips.zen": "async-coder と組み合わせて {highlight}/connect{/highlight} で厳選されたモデルを使えます",
  ...
  "tui.toast.update_available.success": "async-coder v{{version}} に更新しました。アプリケーションを再起動してください。",
  ...
  "tui.voice.error.no_auth": "まず async-coder アカウントにログインしてください",
  ...
  "tui.dialog.login.legacy_free.desc": "ログイン不要の匿名無料チャネル",
  "tui.dialog.login.legacy_free.success": "Legacy Free の準備完了 — デフォルトモデルを legacy free model に設定しました",
  "tui.dialog.login.legacy_free.unavailable": "Legacy Free プロバイダーが読み込まれていません",
  "tui.dialog.login.flow.title": "async-coder ログイン",
  ...
  "cli.providers.legacy.recommended_hint": "推奨",
  "cli.providers.legacy_free.hint": "匿名無料チャネル / legacy free model",
  "cli.providers.legacy_free.verifying": "Legacy Free チャネルを検証中...",
  "cli.providers.legacy_free.ready": "Legacy Free チャネル準備完了",
  "cli.providers.legacy_free.failed": "Legacy Free の自己診断に失敗",
  "cli.providers.legacy_free.default_set": "デフォルトモデルを legacy free model に設定（1M コンテキスト、無料）",
  "cli.providers.legacy_free.usage_hint":
    "ログイン不要 — そのまま async-coder を実行できます。有料/上位モデルを利用する場合は async-coder ブラウザログインを選択してください。",
  "cli.providers.legacy_login.decrypt_retry": "復号に失敗しました、再試行してください（残り {remaining} 回）",
  "cli.providers.legacy_login.decrypt_exhausted": "復号に失敗しました、最大再試行回数に達しました",
  ...
  "trust.capabilities": "async-coder はここでファイルの読み取り、編集、実行が可能になります。",
