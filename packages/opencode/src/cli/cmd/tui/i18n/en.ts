export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using async-coder, you agree to our ",
  ...
  "tui.dialog.advisor.provider.connected": "Connected",
  "tui.dialog.advisor.provider.setup_required": "Setup required",
  "tui.dialog.advisor.provider.ollama": "Ollama / local",
  "tui.dialog.advisor.provider.ollama.description": "Discover models from Ollama on localhost",
  "tui.dialog.advisor.provider.custom": "Custom / local provider",
  "tui.dialog.advisor.provider.custom.description": "OpenAI-compatible endpoint (including local servers)",
  ...
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.async-coder/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.async-coder/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent async-coder from reading sensitive files",
  "tui.tips.run": "Use {highlight}async-coder run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}async-coder --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}async-coder run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}async-coder serve{/highlight} for headless API access to async-coder",
  "tui.tips.attach_server": "Use {highlight}async-coder run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}async-coder upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}async-coder auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}async-coder agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}async-coder github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.async-coder/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}async-coder debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with async-coder for curated, tested models",
  ...
  "tui.voice.error.no_auth": "Please log in to async-coder first",
  ...
  "tui.dialog.login.provider": "Provider",
  "tui.dialog.login.provider.desc": "(Recommended)",
  "tui.dialog.login.legacy_free": "Legacy Free",
  "tui.dialog.login.legacy_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.legacy_free.success": "Legacy Free is ready — default model set to legacy free model",
  "tui.dialog.login.legacy_free.unavailable": "Legacy Free provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.legacy.recommended_hint": "recommended",
  "cli.providers.legacy_free.hint": "Anonymous free channel / legacy free model",
  "cli.providers.legacy_free.verifying": "Verifying Legacy Free channel...",
  ...
  "tui.dialog.login.flow.title": "async-coder Login",
