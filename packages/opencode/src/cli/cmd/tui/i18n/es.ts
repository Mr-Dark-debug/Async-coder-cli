...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar async-coder, aceptas nuestros ",
  ...
  "tui.tips.config_files":
    "Crea {highlight}async-coder.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/async-coder/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "async-coder gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.async-coder/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.async-coder/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "async-coder formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "async-coder usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.async-coder/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.async-coder/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a async-coder leer archivos sensibles",
  "tui.tips.run":
    "Usa {highlight}async-coder run{/highlight} para scripting no interactivo",
  "tui.tips.continue":
    "Usa {highlight}async-coder --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}async-coder run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json":
    "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve":
    "Ejecuta {highlight}async-coder serve{/highlight} para acceso headless a la API de async-coder",
  "tui.tips.attach_server":
    "Usa {highlight}async-coder run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade":
    "Ejecuta {highlight}async-coder upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
    "Ejecuta {highlight}async-coder auth list{/highlight} para ver todos los proveedores configurados",
  "tui.tips.agent_create":
    "Ejecuta {highlight}async-coder agent create{/highlight} para crear un agente con asistente guiado",
  ...
  "tui.tips.github_install":
    "Ejecuta {highlight}async-coder github install{/highlight} para configurar el workflow de GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.async-coder/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}async-coder debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
  ...
  "tui.tips.zen":
    "Usa {highlight}/connect{/highlight} con async-coder para modelos seleccionados y probados",
  "tui.tips.agents_md":
  ...
  "tui.toast.update_available.success": "Se actualizó a async-coder v{{version}}. Por favor reinicie la aplicación.",
  ...
  "tui.voice.error.no_auth": "Inicia sesión en async-coder primero",
  ...
  "trust.capabilities": "async-coder podrá leer, editar y ejecutar archivos aquí.",
  ...
  "tui.dialog.login.flow.title": "Inicio de sesión async-coder",
