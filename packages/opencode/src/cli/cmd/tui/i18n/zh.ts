...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 async-coder 即表示你同意我们的",
  ...
  "tui.tips.config_files":
    "创建 {highlight}async-coder.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/async-coder/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "async-coder 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.async-coder/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.async-coder/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.formatter": "async-coder 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "async-coder 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.async-coder/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.async-coder/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 async-coder 读取敏感文件",
  "tui.tips.run": "用 {highlight}async-coder run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}async-coder --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}async-coder run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}async-coder serve{/highlight} 以无头模式提供 async-coder API",
  "tui.tips.attach_server": "用 {highlight}async-coder run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}async-coder upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}async-coder auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}async-coder agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/opencode{/highlight} 触发 AI 操作",
  "tui.tips.github_install": "运行 {highlight}async-coder github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.async-coder/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.tips.debug_config": "运行 {highlight}async-coder debug config{/highlight} 排查配置问题",
  ...
  "tui.tips.zen": "搭配 async-coder 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
  ...
  "tui.toast.update_available.success": "已更新到 async-coder v{{version}}，请重启应用。",
  ...
  "tui.voice.error.no_auth": "请先登录 async-coder 账号",
  ...
  "tui.dialog.login.provider": "小米",
  "tui.dialog.login.provider.desc": "（推荐）",
  "tui.dialog.login.legacy_free": "Legacy Free",
  "tui.dialog.login.legacy_free.desc": "免费匿名通道，无需登录",
  "tui.dialog.login.legacy_free.success": "Legacy Free 已就绪 - 默认模型设为 legacy free model",
  "tui.dialog.login.legacy_free.unavailable": "Legacy Free 通道未加载",
  "cli.providers.select": "选择服务商",
  "cli.providers.other": "其他 Provider",
  "cli.providers.legacy.recommended_hint": "推荐",
  "cli.providers.legacy_free.hint": "免费匿名通道 / legacy free model",
  "cli.providers.legacy_free.verifying": "正在验证 Legacy Free 通道...",
  "cli.providers.legacy_free.ready": "Legacy Free 通道已就绪",
  "cli.providers.legacy_free.failed": "Legacy Free 自检失败",
  "cli.providers.legacy_free.default_set": "默认模型已切换为 legacy free model（1M 上下文，免费）",
  "cli.providers.legacy_free.usage_hint": "无需登录，直接 async-coder run 即可使用。如需付费/更高级模型，可重新选择 async-coder 浏览器登录。",
  "cli.providers.legacy_login.decrypt_retry": "解密失败，请重试 (剩余 {remaining} 次)",
  "cli.providers.legacy_login.decrypt_exhausted": "解密失败，已达最大重试次数",
  ...
  "tui.dialog.login.flow.title": "async-coder 登录",
  ...
  "trust.capabilities": "async-coder 将能够读取、编辑和执行此目录中的文件。",
