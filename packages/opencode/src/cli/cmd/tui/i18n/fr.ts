...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant async-coder, vous acceptez nos ",
  ...
  "tui.tips.config_files":
    "Créez {highlight}async-coder.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/async-coder/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "async-coder gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.async-coder/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.async-coder/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "async-coder formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "async-coder utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.async-coder/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.async-coder/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher async-coder de lire des fichiers sensibles",
  "tui.tips.run": "Utilisez {highlight}async-coder run{/highlight} pour des scripts non interactifs",
  "tui.tips.continue": "Utilisez {highlight}async-coder --continue{/highlight} pour reprendre la dernière session",
  "tui.tips.attach_cli":
    "Utilisez {highlight}async-coder run -f file.ts{/highlight} pour joindre des fichiers via la CLI",
  "tui.tips.format_json":
    "Utilisez {highlight}--format json{/highlight} pour une sortie lisible par machine dans les scripts",
  "tui.tips.serve": "Exécutez {highlight}async-coder serve{/highlight} pour exposer l'API async-coder en mode headless",
  "tui.tips.attach_server":
    "Utilisez {highlight}async-coder run --attach{/highlight} pour vous connecter à un serveur en cours",
  "tui.tips.upgrade": "Exécutez {highlight}async-coder upgrade{/highlight} pour passer à la dernière version",
  "tui.tips.auth_list":
    "Exécutez {highlight}async-coder auth list{/highlight} pour voir tous les fournisseurs configurés",
  "tui.tips.agent_create":
    "Exécutez {highlight}async-coder agent create{/highlight} pour créer un agent en mode guidé",
  ...
  "tui.tips.github_install":
    "Exécutez {highlight}async-coder github install{/highlight} pour configurer le workflow GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.async-coder/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Exécutez {highlight}async-coder debug config{/highlight} pour diagnostiquer la configuration",
  "tui.tips.print_logs":
  ...
  "tui.tips.zen":
    "Utilisez {highlight}/connect{/highlight} avec async-coder pour des modèles testés et sélectionnés",
  "tui.tips.agents_md":
  ...
  "tui.toast.update_available.success": "Mis à jour vers async-coder v{{version}}. Veuillez redémarrer l'application.",
  ...
  "tui.voice.error.no_auth": "Veuillez d'abord vous connecter à async-coder",
  ...
  // Legacy Free — TUI login dialog
  "tui.dialog.login.legacy_free": "Legacy Free",
  "tui.dialog.login.legacy_free.desc": "Canal anonyme gratuit — aucune connexion requise",
  "tui.dialog.login.legacy_free.success": "Legacy Free est prêt — modèle par défaut défini sur legacy free model",
  "tui.dialog.login.legacy_free.unavailable": "Fournisseur Legacy Free non chargé",
  "tui.dialog.login.flow.title": "Connexion async-coder",
  ...
  "cli.providers.legacy.recommended_hint": "recommandé",
  "cli.providers.legacy_free.hint": "Canal anonyme gratuit / legacy free model",
  "cli.providers.legacy_free.verifying": "Vérification du canal Legacy Free...",
  "cli.providers.legacy_free.ready": "Canal Legacy Free prêt",
  "cli.providers.legacy_free.failed": "Échec de la vérification de Legacy Free",
  "cli.providers.legacy_free.default_set": "Modèle par défaut défini sur legacy free model (contexte 1M, gratuit)",
  "cli.providers.legacy_free.usage_hint":
    "Aucune connexion requise — exécutez simplement async-coder. Pour les modèles payants/premium, choisissez plutôt la connexion navigateur async-coder.",
  "cli.providers.legacy_login.decrypt_retry": "Échec du déchiffrement, veuillez réessayer ({remaining} tentatives restantes)",
  "cli.providers.legacy_login.decrypt_exhausted": "Échec du déchiffrement, nombre maximal de tentatives atteint",
  ...
  "trust.capabilities": "async-coder pourra lire, modifier et exécuter des fichiers ici.",
