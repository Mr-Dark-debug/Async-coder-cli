...
const PACKAGE_NAME = "async-coder"
...
export const USER_AGENT = `async-coder/${InstallationChannel}/${InstallationVersion}/${Flag.ASYNC_CODER_CLIENT}`
...
// TODO(async-coder): uncomment when corresponding channels are supported
...
export const layer: Layer.Layer<Service, never, HttpClient.HttpClient | ChildProcessSpawner.ChildProcessSpawner> =
  Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      // TODO(async-coder): uncomment when async-coder is published to homebrew
      ...
      const upgradeCurl = Effect.fnUntraced(
        function* (target: string) {
          const response = yield* httpOk.execute(HttpClientRequest.get("https://github.com/Mr-Dark-debug/Async-coder-cli/install"))
      ...
      const methodImpl = Effect.fn("Installation.method")(function* () {
        if (process.execPath.includes(path.join(".async-coder", "bin"))) return "curl" as Method
        ...
        const checks: Array<{ name: Method; command: () => Effect.Effect<string> }> = [
          ...
          // TODO(async-coder): uncomment when async-coder is published to these channels
      ...
      const latestImpl = Effect.fn("Installation.latest")(function* (installMethod?: Method) {
        ...
        if (detectedMethod === "curl") {
          const headers = yield* text([
            "curl",
            "-sI",
            "https://github.com/Mr-Dark-debug/Async-coder-cli/releases/latest",
          ])
        ...
        // TODO(async-coder): uncomment when async-coder is published to chocolatey
        ...
        // TODO(async-coder): uncomment when async-coder is published to scoop
        ...
        // TODO(async-coder): uncomment when async-coder has github releases
        // const response = yield* httpOk.execute(
      ...
      const upgradeImpl = Effect.fn("Installation.upgrade")(function* (m: Method, target: string) {
        ...
        if (!result || result.code !== 0) {
          // TODO(async-coder): restore choco-specific error when choco channel is supported
