...
<p align="center">
  <a href="https://github.com/Mr-Dark-debug/Async-coder-cli">Website</a> | <a href="https://github.com/Mr-Dark-debug/Async-coder-cli/en/blog/mimo-code-long-horizon">Blog</a>
</p>
...
async-coder is built as a fork of [OpenCode](https://github.com/Mr-Dark-debug/Async-coder-cli). It keeps all core OpenCode capabilities (multiple providers, TUI, LSP, MCP, plugins) and adds persistent memory, intelligent context management, subagent orchestration, goal-driven autonomous loops, compose workflows, and self-improvement via dream/distill.
...
Use of async-coder is also subject to the [Use Restrictions](./USE_RESTRICTIONS.md).
